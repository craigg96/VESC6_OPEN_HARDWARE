...
#ifndef HW_V6OHW_CORE_H_
#define HW_V6OHW_CORE_H_

#ifdef HW_V6OHW_IS_MK1
#define HW_NAME                 "V6OHW"
#else
...
// Voltage and temperature macros
